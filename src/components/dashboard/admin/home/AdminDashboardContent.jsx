        ...
        <div className="space-y-6 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="border border-zinc-900 bg-zinc-950 p-6 rounded-2xl shadow-xl flex flex-col">
                    ...
                    <div className="flex-grow space-y-3 overflow-y-auto max-h-48 pr-1">
                            ...
                            topContributors.map((user, index) => (
                                <div key={user._id} className="flex items-center justify-between">
                                    <div className="flex items-center gap-3 min-w-0">
                                        ...
                                        {user.image ? (
                                            <img src={user.image} className="w-7 h-7 rounded-full object-cover border border-zinc-800" alt="" />
                                        ) : (
